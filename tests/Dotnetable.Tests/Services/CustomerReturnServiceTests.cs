...
public class CustomerReturnServiceTests : IDisposable
{
    ...
    public CustomerReturnServiceTests()
    {
        ...
        _svc = new CustomerReturnService(factory, _stock.Object, _attach.Object);
        Seed();
    }
    ...
    private void Seed()
    {
        ...
        order.OrderItems.Add(new OrderItem
        {
            ...
            Quantity = 5, UnitPrice = 30, UnitPriceUsd = 30, TotalPrice = 150, TitleSnapshot = "A", SkuSnapshot = "A-1",
        });
        order.OrderItems.Add(new OrderItem
        {
            OrderItemID = 802, OrderID = 80, WebsiteID = 1, SourceWebsiteID = 1, ProductVariantID = 2,
            Quantity = 3, UnitPrice = 33.33m, UnitPriceUsd = 33.33m, TotalPrice = 100, TitleSnapshot = "B", SkuSnapshot = "B-1",
        });
    ...
    public async Task Approve_RequiresShippingPayer_AndCreatesWms()
    {
        ...
        var ok = await _svc.ApproveAsync(created.Request.CustomerReturnRequestID, ReturnShippingPayer.Site, "ok",
            new[]
            {
        ...
        saved.ShippingPayer.Should().Be((byte)ReturnShippingPayer.Site);
