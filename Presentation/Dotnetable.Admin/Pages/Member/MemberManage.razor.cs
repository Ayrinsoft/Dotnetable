using Dotnetable.Admin.Components.Member.Manage;
...
public partial class MemberManage
{
    ...
    private void InsertNewMemberContact(int memberID) =>
        _dialogService.Show<Components.Member.Profile.ContactMemberDialog>(_loc["_Member_Insert_New_Address"], options: new DialogOptions { CloseButton = true, CloseOnEscapeKey = true }, parameters: new() { { "ContactModel", new MemberContactRequest() { CurrentMemberID = memberID } }, { "FunctionName", "ContactInsertAdmin" } });
