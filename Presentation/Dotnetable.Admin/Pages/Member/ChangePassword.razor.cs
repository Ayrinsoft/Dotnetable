...
public partial class ChangePassword
{
    ...
    private Shared.DTO.Member.MemberChangePasswordRequest _changeRequest = new();
    ...
    private async Task DoChangePassword()
    {
        ...
        var changeObject = changePasswordResponse.ResponseData.CastModel<Shared.DTO.Public.PublicActionResponse>();
