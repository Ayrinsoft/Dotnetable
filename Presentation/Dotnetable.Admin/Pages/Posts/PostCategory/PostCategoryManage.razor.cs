...
using Dotnetable.Admin.Components.Posts.PostCategory;
...
public partial class PostCategoryManage
{
    ...
    private async Task UpdatePriorityChanges()
    {
        ...
        {
            var parsedResponse = serviceResponse.ResponseData.CastModel<Shared.DTO.Public.PublicActionResponse>();
    ...
    private async Task EditItem(ItemClickEventArgs e)
    {
        ...
        var updateparsedResponse = updateServiceResponse.ResponseData.CastModel<Shared.DTO.Public.PublicActionResponse>();
