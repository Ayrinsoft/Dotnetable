...
namespace Dotnetable.Admin.Pages.AppSettings;
...
public partial class ConfigSettings
{
    ...
    private AdminPanelAppSettingsResponse _appSettings = new() { AdminPanelSettings = new(), ConnectionStrings = new(), DBSettings = new() };
    ...
    private async Task SaveSettings()
    {
        ...
        _ = Enum.TryParse(_appSettings.DBSettings.DBType, out Shared.DTO.Public.DatabaseType _dbTypeEnum);
