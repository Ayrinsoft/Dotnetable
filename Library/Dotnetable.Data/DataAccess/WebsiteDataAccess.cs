...
public class WebsiteDataAccess
{
    ...
    public static async Task<PublicActionResponse> InsertFirstData(AdminPanelFirstDataRequest requestModel)
    {
        ...
        try
        {
            ...
            db.TB_Posts.Add(new() { Title = "Contact us", Summary = "Contact us", PostCode = "ContactUs", Active = true, Body = "{\"PhoneNumber\":{\"\":\"\"},\"Address\":{\"\":\"\"},\"HTMLBody\":\"\\u003Cp\\u003EContact us\\u003C/p\\u003E\",\"EmailAddress\":{\"\":\"\"},\"Faxnumber\":{\"\":\"\"},\"WorkHours\":[{\"FromHour\":\"09\",\"ToHour\":\"18\",\"WeekDays\":\"Sat-Fri\"}],\"MapLocationLatitude\":\"\",\"MapLocationLongitude\":\"\"}", FileCode = null, LanguageCode = fetchPostCategory.LanguageCode, LogTime = DateTime.Now, MemberID = memberObj.MemberID, PostCategoryID = fetchPostCategory.PostCategoryID, MetaDescription = "", MetaKeywords = "", Tags = "", NormalBody = false, VisitCount = 0 });

            db.TB_Posts.Add(new() { Title = "About us", Summary = "About us", PostCode = "AboutUs", Active = true, Body = "{\"HTMLBody\":\"\\u003Cp\\u003EAbout us\\u003C/p\\u003E\",\"RelatedCompanies\":{\"\":\"\"},\"OtherHtmlPart\":{\"\":\"\"}}", FileCode = null, LanguageCode = fetchPostCategory.LanguageCode, LogTime = DateTime.Now, MemberID = memberObj.MemberID, PostCategoryID = fetchPostCategory.PostCategoryID, MetaDescription = "", MetaKeywords = "", Tags = "", NormalBody = false, VisitCount = 0 });

            db.TB_Posts.Add(new() { Title = "QR Code", Summary = "QR Code", PostCode = "QRCode", Active = true, Body = "{\"HTMLBody\":\"\\u003Cp\\u003EQR Code\\u003C/p\\u003E\",\"OtherHtmlPart\":{\"\":\"\"},\"RedirectURL\":\"/\"}", FileCode = null, LanguageCode = fetchPostCategory.LanguageCode, LogTime = DateTime.Now, MemberID = memberObj.MemberID, PostCategoryID = fetchPostCategory.PostCategoryID, MetaDescription = "", MetaKeywords = "", Tags = "", NormalBody = false, VisitCount = 0 });
