        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "varbinary(8)", maxLength: 8, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MarketplaceChannelID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    WebsiteID = table.Column<int>(type: "int", nullable: false),
                    ...
                    FeedToken = table.Column<string>(type: "varchar(64)", unicode: false, maxLength: 64, nullable: false),
                    IncludeAllProducts = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    SyncIntervalMinutes = table.Column<int>(type: "int", nullable: false),
                    LastSyncAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: true),
                    LastSyncStatus = table.Column<byte>(type: "tinyint unsigned", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SettingsJSON = table.Column<string>(type: "varchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutEndUtc = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MarketplaceSyncLogID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    MarketplaceChannelID = table.Column<int>(type: "int", nullable: false),
                    StartedAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: false),
                    FinishedAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: true),
                    Status = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    TriggeredBy = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MarketplaceChannelCategoryID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    MarketplaceChannelID = table.Column<int>(type: "int", nullable: false),
                    ProductCategoryID = table.Column<int>(type: "int", nullable: false),
                    IsIncluded = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
                    RemoteCategoryID = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    RemoteCategoryPath = table.Column<string>(type: "varchar(400)", maxLength: 400, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pricing = table.Column<byte>(type: "tinyint unsigned", nullable: false, defaultValue: (byte)0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockedUntil = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: false),
                    RevokedAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePriceUsd = table.Column<decimal>(type: "decimal(18,4)", nullable: false, defaultValue: 0m),
                    LinkToUsd = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MarketplaceChannelProductID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    MarketplaceChannelID = table.Column<int>(type: "int", nullable: false),
                    ProductID = table.Column<int>(type: "int", nullable: false),
                    IsIncluded = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RemoteProductID = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    LastSyncedAt = table.Column<DateTime>(type: "datetime(0)", precision: 0, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayAuthority = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true),
                    TrackingCode = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
