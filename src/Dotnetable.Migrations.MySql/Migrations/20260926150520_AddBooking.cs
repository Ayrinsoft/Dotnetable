    ...
    public partial class AddBooking : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingProfileID = table.Column<int>(type: "int", nullable: false)
                    ...
                    RetentionDays = table.Column<int>(type: "int", nullable: false, defaultValue: 180),
                    RequirePayment = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
                    AllowOnlinePayment = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
                    AllowOfflinePayment = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
                    HoldMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 30),
                    LeadMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 60),
                    DayStartMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 540),
                    DayEndMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 1020),
                    WorkDays = table.Column<byte>(type: "tinyint unsigned", nullable: false, defaultValue: (byte)31),
                    BreakStartMinutes = table.Column<int>(type: "int", nullable: true),
                    BreakEndMinutes = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingResourceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    WebsiteID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingClosureID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    WebsiteID = table.Column<int>(type: "int", nullable: false),
                    BookingResourceID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingOfferingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    WebsiteID = table.Column<int>(type: "int", nullable: false),
                    BookingResourceID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingAppointmentID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    WebsiteID = table.Column<int>(type: "int", nullable: false),
                    BookingResourceID = table.Column<int>(type: "int", nullable: false),
                    BookingOfferingID = table.Column<int>(type: "int", nullable: false),
