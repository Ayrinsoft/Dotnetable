...
namespace Dotnetable.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20260726160921_DigitalDeliveryLibrary")]
    partial class DigitalDeliveryLibrary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dotnetable.Domain.Entities.OrderDigitalAsset", b =>
                {
                    ...
                    b.HasIndex(new[] { "DigitalFileID" }, "IX_OrderDigitalAssets_DigitalFileID");
            ...
            modelBuilder.Entity("Dotnetable.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex(new[] { "DigitalFileID" }, "IX_Products_DigitalFileID");
            ...
            modelBuilder.Entity("Dotnetable.Domain.Entities.OrderDigitalAsset", b =>
                {
                    b.HasOne("Dotnetable.Domain.Entities.FileRecord", "DigitalFile")
                        .WithMany("OrderDigitalAssets")
                        .HasForeignKey("DigitalFileID")
                        .HasConstraintName("FK_OrderDigitalAssets_FileRecords");
            ...
            modelBuilder.Entity("Dotnetable.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Dotnetable.Domain.Entities.FileRecord", "DigitalFile")
                        .WithMany("ProductDigitalFiles")
                        .HasForeignKey("DigitalFileID")
                        .HasConstraintName("FK_Products_DigitalFile");
            ...
            modelBuilder.Entity("Dotnetable.Domain.Entities.FileRecord", b =>
                {
                    ...
                    b.Navigation("ProductDigitalFiles");
