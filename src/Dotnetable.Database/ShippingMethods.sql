CREATE TABLE [dbo].[ShippingMethods] (
    ...
    [FreeShippingMinOrderAmount]     DECIMAL (18, 4) NOT NULL CONSTRAINT [DF_ShippingMethods_FreeShippingMinOrderAmount] DEFAULT ((0)),
    [FreeShippingMinOrderAmountUsd]  DECIMAL (18, 4) NOT NULL CONSTRAINT [DF_ShippingMethods_FreeShippingMinOrderAmountUsd] DEFAULT ((0)),
