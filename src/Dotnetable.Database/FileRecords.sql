CREATE TABLE [dbo].[FileRecords] (
    ...
    [ThumbnailCheckedAt]       DATETIME        NULL,
    [ThumbnailAttempts]        TINYINT         CONSTRAINT [DF_FileRecords_ThumbnailAttempts] DEFAULT ((0)) NOT NULL,
    [CacheControlSetAt]        DATETIME        NULL,
    [CacheControlAttempts]     TINYINT         CONSTRAINT [DF_FileRecords_CacheControlAttempts] DEFAULT ((0)) NOT NULL,
