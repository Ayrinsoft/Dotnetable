CREATE TABLE [dbo].[ClientWalletTransactions] (
    ...
    [AmountUsd]                 DECIMAL (18, 4) NOT NULL CONSTRAINT [DF_ClientWalletTransactions_AmountUsd] DEFAULT ((0)),
    [BalanceAfter]              DECIMAL (18, 4) NOT NULL,
    [BalanceAfterUsd]           DECIMAL (18, 4) NOT NULL CONSTRAINT [DF_ClientWalletTransactions_BalanceAfterUsd] DEFAULT ((0)),
