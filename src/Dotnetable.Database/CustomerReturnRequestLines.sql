CREATE TABLE [dbo].[CustomerReturnRequestLines] (
    ...
    [UnitCost]                    DECIMAL (18, 4) CONSTRAINT [DF_CustomerReturnRequestLines_UnitCost] DEFAULT ((0)) NOT NULL,
    ...
    [ReceivedCondition]           TINYINT         CONSTRAINT [DF_CustomerReturnRequestLines_ReceivedCondition] DEFAULT ((0)) NOT NULL,
    [HealthGrade]                 TINYINT         CONSTRAINT [DF_CustomerReturnRequestLines_HealthGrade] DEFAULT ((0)) NOT NULL,
