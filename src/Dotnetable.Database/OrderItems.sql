CREATE TABLE [dbo].[OrderItems] (
    ...
    [UnitCostUsd]      DECIMAL (18, 4) CONSTRAINT [DF_OrderItems_UnitCostUsd] DEFAULT ((0)) NOT NULL,
    [DiscountAmount]   DECIMAL (18, 4) CONSTRAINT [DF_OrderItems_DiscountAmount] DEFAULT ((0)) NOT NULL,
