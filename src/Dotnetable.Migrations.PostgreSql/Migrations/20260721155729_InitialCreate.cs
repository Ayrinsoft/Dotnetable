        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorType = table.Column<byte>(type: "smallint", nullable: false, defaultValue: (byte)0, comment: "0 = Display-only title, 1 = Member login (manage own catalog), 2 = Linked website (inter-site virtual credit)"),
                    MemberID = table.Column<int>(type: "integer", nullable: true),
                    LinkedWebsiteID = table.Column<int>(type: "integer", nullable: true),
                    AvailableCreditUsd = table.Column<decimal>(type: "numeric(18,4)", nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
