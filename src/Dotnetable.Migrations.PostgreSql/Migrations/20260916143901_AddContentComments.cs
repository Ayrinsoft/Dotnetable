    ...
    public partial class AddContentComments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContentCommentID = table.Column<int>(type: "integer", nullable: false)
                    ...
                    ModeratedAt = table.Column<DateTime>(type: "timestamp(0) with time zone", precision: 0, nullable: true),
                    ModeratedByMemberID = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
