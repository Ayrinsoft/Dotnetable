    ...
    /* ───────── Account ───────── */
    {
      ...
      pages: [
        ...
        },
        {
          ...
          summary: {
            en: "Customer RMA (ClientPurchase). Pre-request with selected lines, reason, description and photos. After admin approval (shipping payer + refund amounts), submit tracking. Partial quantities allowed; leftover units can be returned later.",
            fa: "برگشت مشتری (ClientPurchase). پیش‌درخواست با خطوط انتخابی، علت، توضیح و عکس. بعد از تأیید ادمین (پرداخت‌کننده حمل + مبلغ استرداد) کد رهگیری ثبت می‌شود. تعداد جزئی مجاز است.",
          },
